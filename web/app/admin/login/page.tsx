...
export default function AdminLogin() {
  ...
  return (
    <div className="flex h-full items-center justify-center">
      ...
      <form onSubmit={handleLogin} className="p-6 rounded shadow-md w-full max-w-sm">
        ...
        <div className="mb-4">
          ...
          <input 
            ...
            required 
            className="mt-1 p-2 w-full border border-gray-300 rounded text-gray-900" 
          />
        </div>
        ...
        <button 
          type="submit" 
          disabled={loading} 
          className={`w-full p-2 text-white ${loading ? 'bg-gray-500' : 'bg-primary-500 hover:bg-primary-600'} rounded`}
        >
...
const Logo = () => {
  ...
  <g id="g10" transform="matrix(1.25,0,0,-1.25,0,445)">
    <path id="path14" className="st0" d="M693.7,355.5c-21.6-10.7-21.2-44.1-47.4-52.6c-35.8-16.5-76.5-19-115-25.1
    ...
    <path id="path36" className="st0" d="M540,249c-11.8-0.5-18.3-12.2-23.3-21.4c-2.1-5.1-7.5-15.6-10.3-4.8c-4.1,7.2-6.7,16.6-14.2,20.9
    ...
    <path id="path38" className="st0" d="M178.2,244.9c-7.8-0.1-15.8,0.3-22.7-3.9c-7.8-4.3-10.5-13.7-15.3-20.9
    ...
    <path id="path44" className="st0" d="M426.6,222.8c-2.3,0-4.6-0.4-6.1-2.3c-2.7-5.8-6.9-13.1-2.9-19.7c7.1-2.7,15-0.6,20.4,4.1
    ...
    <path id="path46" className="st0" d="M186.9,222.5c-1.9,0-3.7-0.2-5.5-0.7c-2.6-1.8-4.4-4.4-5.3-7.2c-1.4-6.5,0.1-12.9,3.6-18
    ...
    <path id="path52" className="st0" d="M335.7,199.7c1.3-6-1.3-11.5-1.4-17.5c0.8-5.5-1.5-10.2-1.7-15.6c-0.7-1.3-1.6-2.7-3.1-3.1
      c-1.4-0.5-2.2,0.8-2.9,1.4c1.2,11.4-1.9,25.2,3.6,35.1C331.3,202.4,335.2,202.6,335.7,199.7"/>
    <path id="path54" className="st0" d="M410.6,176.3c-0.5,0-1,0-1.5-0.1c-3.6-0.9-4.2-4.9-5.5-7.7c-0.2-4.7-1.9-11.2,1.5-15.1
    ...
    <path id="path58" className="st0" d="M274.5,126.5c2.3-2.3,1.3-6,3.6-8.4c3.9,0.5,3.1,5.1,4.6,7.7c0.7,1,1.8,1.6,2.8,1
    ...
    <path id="path60" className="st0" d="M546.1,128c-1.6,0-3.2-0.4-4.7-0.9c-8.1-4.8-14.8-13-13.2-22.8c1.9-6.4,7.8-12.1,14.6-12.7
    ...
    <path id="path62" className="st0" d="M241.6,127.7c-3.5-1.2-3.8-5.1-6.2-7.4c-3.2,0.9-4.6,6.5-8.9,5.8c-6.3-3.3-4.2-11.8-6.7-17.6
    ...
    <path id="path64" className="st0" d="M346.2,127.2c-2.8-0.1-5.3-1.8-7.9-2.8c-7.8-4.9-10.2-13.9-8.6-22.8c1.7-4.6,6.2-8.3,11-8.9
    ...
    <path id="path66" className="st0" d="M169.9,122.9c0.4-2.4,0.6-5.8-2.4-6.7c-3.6-0.5-6.9,4.6-9.9,0.7c-0.4-0.8,0.5-2,1.5-2.1
    ...
    <path id="path68" className="st0" d="M522.7,124.4c0.6-1.9,1.7-3.9,0.9-6c-2.6-3-7.5-2.3-11.3-2.4c-2.4-1.9-1.2-5.6-1.2-8.2
    ...
    <path id="path70" className="st0" d="M471.6,125.3c-7.2-0.2-13.7-3.9-17.8-10c-1.3-3,0.3-6,2.1-8.2c1-1.9-0.6-3.4-1.4-4.8
    ...
    <path id="path72" className="st0" d="M385.3,125.2c-4.5,0-9.2-1.8-12.1-4.4c-1.7-2.2-2.7-5-1.9-7.9c2.9-4.7-2.5-8.5,0-13
    ...
    <path id="path74" className="st0" d="M420.5,123.9c-5.2-2.9-7.5-8.6-11.3-13c-2.5-5.2-6.8-9.9-6.4-16c5.6-7.2,6.3,5.9,12,5
    ...
    <path id="path88" className="st0" d="M313.4,100.4c1-2.1,0.3-4.7-1-6.5c-1.1-0.9-3-1.4-4.3-0.5c-1.2,0.7-2.1,1.9-2.4,3.1
      c-0.3,1.9,0.4,3.4,1.2,4.8C308.7,103.3,312.2,103.1,313.4,100.4"/>
    <path id="path90" className="st0" d="M527.9,83.1c0.6-2.4,0.2-4.9-1.4-6.7c-2.1-2.2-5.1-2.9-8.2-2.2c-1.2,0.8-2.8,1.6-3.3,3.1
      c-0.6,3.5,0.6,7.1,3.6,9.2c1.4,1.1,3.6,1.6,5.3,0.7C525.8,86.3,527,85.1,527.9,83.1"/>
    <path id="path92" className="st0" d="M544.7,87.4c-2.6,0.1-5.2-0.9-6.7-2.8c-2.5-2.2,0-5.8-2.1-7.9c-12.7-0.9-14.8-15.1-20.7-23.3
    ...
    <path id="path94" className="st0" d="M165.8,79.3c-6-0.1-12.3-1.3-18-1.2c-2.5-1.2-3.6-3.8-3.8-6.3c2-6.2,1.1-13.9,1.6-20.4
    ...
    <path id="path96" className="st0" d="M295.4,75.9c0.4-2.3,0.4-5.1-1-7c-1.8-2-4.4-0.2-6.5,0.3c-3.3,0.1-6.8,0.2-8.6-2.9
    ...
    <path id="path98" className="st0" d="M371.7,78.8c-2.4,0-4.8,0-7.1,0c-2.5-0.2-5.1-0.3-7-2.2c-1-1.6-0.9-3.7-0.9-5.7
    ...
    <path id="path100" className="st0" d="M236.6,76.6c1.6-0.7,3.8-1.5,4.3-3.6c0.4-2.3-0.4-4.2-2.4-5.3c-8.1-1.5-16.3,0.9-24.7,0.8
    ...
    <path id="path102" className="st0" d="M469.6,78.4c-3,0-5.2-0.2-6-0.6c-1.5-0.7-3.4-1-4.3-2.9c-1.1-9.1,0.7-17.5,2.2-25.9
    ...
    <path id="path104" className="st0" d="M438.9,75.4c1.6-1.2,2-3.2,1.4-5c0-1.5-1.7-2.3-2.8-2.7c-7.4-1-13.8,3-21.2,1.2
    ...
    <path id="path106" className="st0" d="M342.9,73.7c-0.9-6.8,0.4-14,1.7-20.6c-0.2-5.3-1.7-10.7-7-13.2c-5.4-4.5-13.7-1.6-19.9-0.7
